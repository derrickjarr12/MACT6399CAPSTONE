...
1. Open the SAION GUI at http://localhost:5174
2. Click the **VISUALIZE** tab
3. In the orb module controls, find **"DigitalOcean / CDN Texture URL"**
...
| GUI Visualize tab | http://localhost:5174 → VISUALIZE |
