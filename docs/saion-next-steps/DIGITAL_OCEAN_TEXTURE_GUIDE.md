...
- **UI controls**: Easy-to-use texture URL input fields in the VISUALIZE tab
...
### Step 2: Add Texture URLs in VISUALIZE Tab

1. Navigate to the **CONTROLS** tab
2. Scroll down to **"DigitalOcean / CDN Texture URL"** section in the orb module controls
...
- [gui/src/App-new.jsx](gui/src/App-new.jsx)
  ...
  - Added texture UI controls in VISUALIZE tab
...
3. Test CORS with a simple curl request:
   ```bash
  curl -i -H "Origin: http://localhost:5174" https://your-cdn.digitaloceanspaces.com/texture.jpg
   ```
